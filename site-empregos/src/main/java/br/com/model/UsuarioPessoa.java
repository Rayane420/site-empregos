...
public class UsuarioPessoa {
	...
	public String toString() {
		return "UsuarioPessoa [id=" + id + ", nomeCompleto=" + nomeCompleto + ", login=" + login + ", senha=" + senha
				...
				+ ", cpf=" + cpf + ", cargoDesejado=" + cargoDesejado + ", linkedin=" + linkedin
				+ ", github=" + github + ", cep=" + cep + ", logradouro=" + logradouro + ", complemento=" + complemento
				+ ", bairro=" + bairro + ", localidade=" + localidade + ", uf=" + uf + ", telefones=" + telefones
				+ ", emails=" + emails + "]";
	}
	@Override
	public int hashCode() {
